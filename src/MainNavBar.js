...
console.log(this.state.usercart.length)
    ...
    <div className="col-lg-4 col-md-4 col-sm-12 col-12 cartCol">
      ...
      {this.state.usercart && sessionStorage.getItem('user')? (
       ...
       { this.state.usercart.map((a)=>(
          ...
          <div className="row">
          <div className="col-5">
<img src={a.prod_image} className="cartorderimg p-2" ></img><i class="fa fa-window-close" onClick={this.deletemodal.bind(this,a)} ></i>
            </div>
            <div className="col-7">
        ...
        <button className="btn cartorderview px-4 pt-2" onClick={this.addtocart}>Proceed to checkout</button>
        </div>
      ):
      (<div>
          ...
          <div className="col-lg-2 col-md-3 col-sm-3 col-3 ">
            <ul className="userbagul mt-lg-5 ">
              <li className="userbagli">
                <i className="fa fa-shopping-bag mx-md-4 mx-sm-3 " onClick={this.openCart}></i>
              </li>
              <li className="userbagli">
