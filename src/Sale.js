...
sale:'',
  ...
  async componentDidMount() {
    ...
    // inserting specific header category data

      (this.state.brands.map(brand=>(brand.sale!=="no sale") ? (this.state.specificCat.push(brand)):('hi')
    ))
    var a=this.state.specificCat.length;
    // var s=this.state.specificCat.slice(1,a);k
     this.setState({s:this.state.specificCat.slice(1,a)})
    ...
    this.setState({
      pageCount: Math.ceil(this.state.s.length / this.state.perPage),
    })
  }
  ...
  render() {
    const slice = this.state.s.slice(this.state.offset, this.state.offset + this.state.perPage);
    const type = this.state.s.filter(brand => (brand.type == this.state.info) || (brand.color == this.state.info) ||
...
//      var a=slice[i].price*slice[i].sale/100;
//      var newPrice=Math.ceil(slice[i].price-a);
//      console.log(newPrice)
//      this.state.sale.push(newPrice)
//     // //  console.log(this.state.sale[i])
//    }
     console.log(this.state.specificCat)
        ...
        <div className="container-fluid">
          ...
          <nav aria-label="breadcrumb" >
            <ol className="breadcrumb" >
              ...
              <i className="right angle icon divider"></i>
              <li className="breadcrumb-item active" aria-current="page">{this.state.s[0].brand}</li>
            </ol>
...
<Link to="/stitched" className="navlinks"><li  onClick={function(){
             localStorage.removeItem("url")
             localStorage.setItem("url","https://pehnawaywomenclothing.000webhostapp.com/api/post/read.php ")
             ...
             window.location.reload(true)
                ...
                <Link to="/stitched" className="navlinks"><li  onClick={function(){
             localStorage.removeItem("url")
             localStorage.setItem("url","https://pehnaway7890.000webhostapp.com/api/post/read.php")
             window.location.reload(true)
          }} >Khaadi</li></Link>  
                <hr></hr>
                <Link to="/stitched" className="navlinks"><li  onClick={function(){
             localStorage.removeItem("url")
             localStorage.setItem("url","https://pehnaway1234.000webhostapp.com/api1/post/read.php")
             window.location.reload(true)
          }} >Nishat</li></Link>  
                <hr></hr>
                <Link to="/stitched" className="navlinks"><li  onClick={function(){
             localStorage.removeItem("url")
             localStorage.setItem("url","https://pehnaway1234.000webhostapp.com/api/post/read.php")
             window.location.reload(true)
          }} >Sana Safinaz</li></Link>  
                <hr></hr>
                <Link to="/stitched" className="navlinks"><li  onClick={function(){
             localStorage.removeItem("url")
             localStorage.setItem("url","https://pehnaway7890.000webhostapp.com/api1/post/read.php ")
             window.location.reload(true)
          }} >Sapphire</li></Link>  
            ...
            <img src="cover.jpg" className="topImage"></img>

              <h2 className="brandheadingimgcol mb-0"  >{this.state.brands[0].brand}</h2>
              <h3 className="stitched_unstitched">Sale</h3>
              ...
              <div className='row  pr-4 mt-0 '  >
                ...
                <div className='col-lg-6 col-md-10 col-9 mt-4'>
                  <div className="itemscalculator p-2">
                    {rows1 ? (
                      <p>Item(s) {rows1} of {this.state.s.length}</p>
                    ) : (
                        <p>Item(s) {this.state.s.length}</p>
                      )}
                        ...
                        (this.state.catg ? (
                          ...
                          filterSlice.map(brand => (
                            <div className='col-lg-4 col-md-4 col-6 pl-0 pb-5 pr-0'>
                              ...
                              //   )}
                            ></img><p className="saleTag">{Math.ceil((((brand.price)-(brand.sale))/(brand.price))*100)}% <p>Off</p></p></Link>
                              <div className="row">
                                <div className="col-lg-7 col-md-7 col-12">
                                  <p className="brandsdatacategory mt-2"> {brand.category_name} </p>
                                </div>
                                <div className="col-lg-5 col-md-5 col-12 " >
                                  <p className="withoutsaleprice">PKR {brand.price}</p>
                                </div>
                                <div className="col-lg-12 col-md-12 col-12 pr-lg-4" >
                                    <p className="saleprice">PKR {brand.sale}</p>
                                  </div>
                              </div>
