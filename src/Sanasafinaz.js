...
class SanaSafinaz extends Component{
  ...
  async componentDidMount(){
    if(!sessionStorage.getItem("userData")){
      ...
      const url="https://pehnaway1234.000webhostapp.com/api/post/read.php";
...
<h1 className="adminheading pt-lg-5 pt-md-5 pt-sm-5 pt-4 px-5">Welcome to Sana Safinaz Admin Pannel</h1>
<hr></hr>
...
<img className="adminimages px-2 pb-4" src={"https://pehnaway1234.000webhostapp.com/api/post/" + brand.image}></img>
