...
class Khaadi extends Component{
  ...
  async componentDidMount(){
    if(!sessionStorage.getItem("userData")){
      ...
      const url="https://pehnaway7890.000webhostapp.com/api/post/read.php";
...
delete(record){
  ...
  axios.post("https://pehnaway7890.000webhostapp.com/api/post/delete.php/", {
      id: record.id
  })
  .then(response=>{
...
submitHandler = e  =>{
 ...
 formData.append("size_id", this.state.size_id);
  ...
  axios.post('https://pehnaway7890.000webhostapp.com/api/post/update.php',formData,config)
...
<div className="form-group"  >
  ...
  <input type="file" className="form-control"  name="file" defaultValue={this.state.file} onChange={(e)=>this.setState({file: e.target.files[0]})}  />
</div>
...
<img className="adminimages px-2 pb-4" src={"https://pehnaway7890.000webhostapp.com/api/post/" + brand.image}></img>
