...
class Nishaat extends Component{
  ...
  async componentDidMount(){
    if(!sessionStorage.getItem("userData")){
      ...
      const url="https://pehnaway1234.000webhostapp.com/api1/post/read.php";
...
<img className="adminimages px-2 pb-4" src={"https://pehnaway1234.000webhostapp.com/api1/post/" + brand.image}></img>
